...
import { REGEX_PASSWORD } from "../../ultils/pattern"; 
    ...
    const formik = useFormik({
        ...
        validationSchema: yup.object({
            ...
            password: yup.string()
                .required('Required !')
                .matches(
                    REGEX_PASSWORD,'Password must have at least 1 lower case, 1 uppercase, 1 number, 1 special symbol, bettwen 6 ~ 12 character'
                ),
            role: yup.string()
